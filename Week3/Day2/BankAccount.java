 ...
 * DESCRIPTION
 * BankAccount class
 * Instance variables: number(int), amount(double), name(String), active(boolean), transactions(ArrayList<String>)
 * Methods: deposit(), withdraw()
 * Stores each action (deposit, withdraw, creation) in the transactions list.
 * Holds a variable(accountsOpened) that counts the number of accounts opened.
 * Provides 3 contructors (default, name-number, all(except transactions)).
 */
